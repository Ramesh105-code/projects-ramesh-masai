  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            >
              ...
              <Link
                fontWeight={"bold"}
                href="https://github.com/Ramesh105-code"
                target="blank"
              >
                GitHub
              </Link>
            ...
            >
              ...
              <Link
                fontWeight={"bold"}
                href="https://www.linkedin.com/in/kuruba-ramesh-110164212/"
                target="blank"
              >
                LinkedIn
              </Link>
            ...
            >
              ...
              <Link
                fontWeight={"bold"}
                href="mailto:sjramnandu128@gmail.com"
              >
                Email
              </Link>
            </Box>
            ...
            >
              <Image
                ...
                mt={5}
              />
              <Link fontWeight={"bold"} href="tel:+917013093327">
                Phone Number
              </Link>
            </Box>
          </Flex>
      ...
      <Text
        ...
        data-aos-duration="700"
      >
        © 2025 Ramesh Kuruba . All rights reserved.
      </Text>
    </Box>
  );
};
